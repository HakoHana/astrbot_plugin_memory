...
window.renderSettingsPage = {
  render: function() {
    ...
    // 加个提示条
    body.innerHTML += '<div id="settings-toast" style="position:fixed;bottom:30px;left:50%;transform:translateX(-50%);background:#1d1d1f;color:#fff;padding:10px 24px;border-radius:24px;font-size:14px;display:none"></div>';
  },
  save: save
};
